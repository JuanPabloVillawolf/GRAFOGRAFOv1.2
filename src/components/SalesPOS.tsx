    ...
    <div className="max-w-none mx-auto space-y-6 px-2 lg:px-4">
      ...
      <AnimatePresence>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-6 gap-6">
          ...
          <div className="flex flex-col sm:flex-row gap-3 search-container">
            <div className="relative flex-1">
              ...
              <input 
                ...
                className={cn(
                  "w-full bg-white border border-mist rounded-xl py-3 pl-12 pr-10 text-sm outline-none focus:border-bark transition-all relative z-10",
                  showSuggestions && searchTerm && "shadow-xl"
                )}
              />
              {searchTerm && (
                <button 
                  ...
                  className="absolute right-4 top-1/2 -translate-y-1/2 text-dust hover:text-espresso z-20"
                >
                  <X size={16} />
                </button>
              )}
              ...
              <AnimatePresence>
                {showSuggestions && searchTerm && filteredProducts.length > 0 && (
                  <motion.div
                    ...
                    className="absolute z-20 left-0 right-0 top-full mt-2 bg-white border border-mist rounded-2xl shadow-2xl overflow-hidden max-h-80 overflow-y-auto"
